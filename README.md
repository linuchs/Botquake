...
L'utente potrà interagire con il Bot tramite appositi comandi, in particolare potrà richiedere i dati sull'ultimo terremoto avvenuto nell'area di interesse, nonché potrà affinare la ricerca con un apposito comando impostando una magnitudine massima.
