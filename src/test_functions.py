...
async def test_start(mocker: MockerFixture):
    update = (
        mocker.AsyncMock()
    )  # come se creiamo un oggetto fittizio update (l'oggetto fittizio sa come vengono eseguiti isuoi metodi e verifica se i metodi vengono effettivmanrte chimati come devono esserli fatti)
